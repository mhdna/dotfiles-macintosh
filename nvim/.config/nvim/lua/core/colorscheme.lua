...
function Quiet()
	...
	vim.api.nvim_set_hl(0, "IncSearch", { underline = 1, bg = "white", fg = "black" })
	vim.api.nvim_set_hl(0, "Search", { underline = 1, bg = "white", fg = "black" })
	vim.api.nvim_set_hl(0, "Substitute", { underline = 1, bg = "white", fg = "black" })
	vim.api.nvim_set_hl(0, "Pmenu", { bg = "black", fg = "white" })
	vim.api.nvim_set_hl(0, "PmenuSel", { underline = 1, bg = "white", fg = "black" })
...
function Default_Dark()
	...
	vim.api.nvim_set_hl(0, "NormalFloat", { bg = colors.brown })
...
function GruberDarker()
	...
	-- vim.api.nvim_set_hl(0, "BufferLineSeparator", { fg = "black", bold = 1, bg = "gray" })
	-- vim.api.nvim_set_hl(0, "BufferLineTabClose", { fg = "black", bold = 1, bg = "gray" })
	-- vim.api.nvim_set_hl(0, "BufferLineCloseButton", { fg = "black", bold = 1, bg = "gray" })
	...
	vim.api.nvim_set_hl(0, "CmpItemKind", { fg = "white" })
	vim.api.nvim_set_hl(0, "MatchParen", { fg = "black", bg = "darkgrey" })
	modify_hl(0, "TelescopeBorder", { fg = "white", bg = 0 })
	modify_hl(0, "TelescopePrompt", { fg = "white", bg = "black" })
end
